# Imagemagick resize servlet example [![Build Status](https://secure.travis-ci.org/soulgalore/imagemagick-servlet.png)](http://travis-ci.org/soulgalore/imagemagick-servlet.png)
