...
public class WhenAThumbnailsCreated {
	...
	public void thetImageDimensionsAreRight() {
		...
		Thumbnail thumbnail = new Thumbnail("mySuperImage-" + dimensions + ".png");
		assertThat(thumbnail.getImageDimensions(),is(dimensions));
		
		thumbnail = new Thumbnail("my-Super_Im.ag._With_.png.----crazy-name-" + dimensions + ".png");
		assertThat(thumbnail.getImageDimensions(),is(dimensions));
	}
	...
	public void theFileNameShouldBeRight() {
		Thumbnail thumbnail = new Thumbnail("mySuperImage-120x29.png");
		assertThat(thumbnail.getOriginalImageName(),is("mySuperImage-120x29.png"));
	}
	...
	public void theOriginalFullnameShouldBeRght() {
		Thumbnail thumbnail = new Thumbnail("mySuperImage-120x29.png");
		assertThat(thumbnail.getOriginalImageNameWithEnding(),is("mySuperImage.png"));
